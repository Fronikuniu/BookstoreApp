...
<head>
    ...
    <link rel="shortcut icon" href="/images/icon-ksiazki.svg">
    <title>Księgarnia internetowa | Ksiazki</title>
</head>
...
<body>
    ...
    <main>
        <div class="landing-page landing-page-books">
            <div class="landing-page-shadow">
                <div class="container">
                    <div class="landing-page__text">
                        <h1>Witaj w dziale poświęconym książkom.</h1>
